...
# bwplo               
png(filename=paste(output_dir,"Plot_bwplot_results_interactions.png",sep=""), width = 25, height = 12, res=600, units = "cm")  
...
# bwplot               
png(filename=paste(output_dir,"Variable_Importance_results_interactions.png",sep=""), width = 30, height = 30, res=600, units = "cm")  
...
# bwplot               
png(filename=paste(output_dir,"Correlation_results_interactions.png",sep=""), width = 15, height = 15, res=600, units = "cm")  
